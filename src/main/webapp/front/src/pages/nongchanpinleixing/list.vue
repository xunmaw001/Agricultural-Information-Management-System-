...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"10px","margin":"20px auto 0","borderColor":"#9cc0e4","alignItems":"center","display":"flex","borderRadius":"4px","flexWrap":"wrap","background":"#e6eff8","borderWidth":"1px","width":"1200px","borderStyle":"solid","height":"auto","order":"2"}'>
      <el-form-item :style='{"margin":"0 10px"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>农产品类型</div>
        <el-input v-model="formSearch.nongchanpinleixing" placeholder="农产品类型" clearable></el-input>
      </el-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      getList(page, fenlei, ref = '') {
        ...
        let searchWhere = {};
        if (this.formSearch.nongchanpinleixing != '') searchWhere.nongchanpinleixing = '%' + this.formSearch.nongchanpinleixing + '%';
        this.$http.get('nongchanpinleixing/list', {params: Object.assign(params, searchWhere)}).then(res => {
          if (res.data.code == 0) {
      ...
      toDetail(item) {
        this.$router.push({path: '/index/nongchanpinleixingDetail', query: {detailObj: JSON.stringify(item)}});
      },
    }
  }
</script>
