	...
	<div class="addEdit-block" :style='{"padding":"30px 0 0 0"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="select" v-if="type!='info'"  label="农产品类型" prop="nongchanpinleixing">
					<el-select :disabled="ro.nongchanpinleixing" v-model="ruleForm.nongchanpinleixing" placeholder="请选择农产品类型" >
						<el-option
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="农产品类型" prop="nongchanpinleixing">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="出产地" prop="chuchandi">
					<el-input v-model="ruleForm.chuchandi" placeholder="出产地" clearable  :readonly="ro.chuchandi"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="出产地" prop="chuchandi">
					<el-input v-model="ruleForm.chuchandi" placeholder="出产地" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="保质期" prop="baozhiqi">
					<el-input v-model="ruleForm.baozhiqi" placeholder="保质期" clearable  :readonly="ro.baozhiqi"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="保质期" prop="baozhiqi">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' v-if="type!='info'"  label="详情描述" prop="xiangqingmiaoshu">
					<editor 
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' v-else-if="ruleForm.xiangqingmiaoshu" label="详情描述" prop="xiangqingmiaoshu">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.xiangqingmiaoshu"></span>
                </el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.xiangqingmiaoshu = this.ruleForm.xiangqingmiaoshu.replace(reg,'../../../ssm9927h/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
